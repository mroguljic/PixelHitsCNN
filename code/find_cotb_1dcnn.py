...
f.close()
'''
print(np.amin(cotb_train),np.amax(cotb_train))
print(np.amin(cotb_test),np.amax(cotb_test))
plot_cot(cotb_train,"cotb_train",img_ext)
plot_cot(cotb_test,"cotb_test",img_ext)
