...
# setup forMorris by loading the auto-generated cfi (see forMorris.fillDescriptions)
process.load("TrackerStuff.PixelHitsCNN.forMorris_cfi")

process.forMorris = cms.EDAnalyzer('forMorris',
...
'''
process.pixelCPECNN_step = cms.Path(process.forMorris)
