...
# setup InferDNN_x by loading the auto-generated cfi (see InferDNN_x.fillDescriptions)
process.load("TrackerStuff.PixelHitsCNN.inferDNN_x_cfi")

process.inferDNN_x = cms.EDAnalyzer('InferDNN_x',
...
#)
process.pixelCPECNN_step = cms.Path(process.inferDNN_x)
