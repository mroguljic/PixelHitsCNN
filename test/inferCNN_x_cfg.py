...
graph_ext = "1dcnn_%s_jul28"%h5_ext
...
fileNames=cms.untracked.vstring("file:MC_5000_phase1_2018_realistic.root"),
# data
...
# setup InferCNN_x by loading the auto-generated cfi (see InferCNN_x.fillDescriptions)
process.load("TrackerStuff.PixelHitsCNN.inferCNN_x_cfi")

process.inferCNN_x = cms.EDAnalyzer('InferCNN_x',
...
#)
process.pixelCPECNN_step = cms.Path(process.inferCNN_x)
