...
# setup InferDNN_y by loading the auto-generated cfi (see InferDNN_y.fillDescriptions)
process.load("TrackerStuff.PixelHitsCNN.inferDNN_y_cfi")

process.inferDNN_y = cms.EDAnalyzer('InferDNN_y',
...
#)
process.pixelCPECNN_step = cms.Path(process.inferDNN_y)
