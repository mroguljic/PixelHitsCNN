...
process.load("TrackerStuff.PixelHitsCNN.inferDNN_cfi")
process.inferDNN.graphPath = cms.string(os.path.join(datadir, "graph_x_%s.pb"%(graph_ext)))
process.inferDNN.inputTensorName = cms.string("input_1")
process.inferDNN.outputTensorName = cms.string("Identity")

# define what to run in the path
process.p = cms.Path(process.inferDNN)
