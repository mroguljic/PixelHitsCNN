...
process.GlobalTag = GlobalTag(process.GlobalTag, 'auto:phase1_2018_realistic', '') #phase-1 2018 irradiated
# data
...
fileNames=cms.untracked.vstring("file:MC_15000_phase1_2018_realistic.root"),  #irrad run 2 2018 L1
