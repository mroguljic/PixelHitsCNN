...
#process.GlobalTag = GlobalTag(process.GlobalTag, '111X_upgrade2018_realistic_v3', '') #phase-1 2018 irradiated
# data
...
#fileNames=cms.untracked.vstring("file:MC_5000_111X_upgrade2018_realistic_v3.root")  #irrad run 2 2018 L1
