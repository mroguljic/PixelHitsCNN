...
if(cpe=="cnn1d"): graph_ext = "1dcnn_%s_sep20"%h5_ext
elif(cpe=="cnn2d"): graph_ext = "2dcnn_%s_sep6"%h5_ext
...
process.load("TrackerStuff.PixelHitsCNN.inferNN_y_cfi")

process.inferNN_y = cms.EDAnalyzer('InferNN_y',
 ...
 inputTensorName_y = cms.string("input_1"),
 anglesTensorName_y = cms.string("input_2"),
...
#)
process.pixelCPECNN_step = cms.Path(process.inferNN_y)
